...
use sp_ark_bls12_377::{
	Bls12_377 as Bls12_377Opt, G1Affine as G1AffineOpt, G2Affine as G2AffineOpt,
};
...
pub fn fast_pairing_opt(
	...
	let looped = Bls12_377Opt::multi_miller_loop([signature.neg(), r], [q, s]);
	let exp = Bls12_377Opt::final_exponentiation(looped);
	exp.unwrap().is_zero()
}
